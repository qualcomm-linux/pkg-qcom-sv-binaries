# Contributing to Packaging repository for qcom-sv-binaries
...
1. [Fork](https://github.com/qualcomm-linux/pkg-qcom-sv-binaries/fork) and clone the repository.

    ```bash
    git clone https://github.com/qualcomm-linux/pkg-qcom-sv-binaries.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-qcom-sv-binaries.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-qcom-sv-binaries/pulls) from your branch to the appropriate distro-specific branch (e.g. `qcom/ubuntu/resolute` or
   `qcom/debian/trixie`).
